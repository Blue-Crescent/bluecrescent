...
#include <bluecrescent_control/bluecrescent_hw_larm.h>
...
BlueCrescent_larm::BlueCrescent_larm()
{
...
void BlueCrescent_larm::read(ros::Time time, ros::Duration period)
{
}

void BlueCrescent_larm::write(ros::Time time, ros::Duration period)
{
